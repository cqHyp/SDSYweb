                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered" id="datatable1">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center">博雅读书</th>
                                <th style="text-align: center">博雅心情</th>
                                <th style="text-align: center">博雅实践</th>
                                <th style="text-align: center">博雅讲坛</th>
                                <th style="text-align: center">博雅修身</th>
                                <th style="text-align: center">博雅视野</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
...
<script type="text/javascript">
        ...
        right = $('#datatable1').DataTable(
            {
                ...
                ajax: encodeURI("getStudentsGrade?twocollege=" + document.getElementById('college').value
    ...
    $("#search").click(function () {
        var url = "getStudentsGrade?twocollege=" + encodeURI(document.getElementById('college').value)
            + "&nianji=" + document.getElementById('nianji').value + "&profession=" + encodeURI(document.getElementById('profession').value)
            + "&classz=" + encodeURI(document.getElementById('classz').value);
        //alert(url)
        var url2 = "getStudentsGrade?twocollege=" + document.getElementById('college').value
            + "&nianji=" + document.getElementById('nianji').value + "&profession=" + document.getElementById('profession').value
            + "&classz=" + document.getElementById('classz').value;
