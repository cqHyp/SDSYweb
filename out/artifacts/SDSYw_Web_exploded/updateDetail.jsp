				...
				<div class="col-lg-10 col-lg-offset-1">
					<div class="ibox">
						<div class="ibox-content">
							<form action="updateActItem" name="cform" method="post" enctype="multipart/form-data" id="upDetailFrom">
								<div class="text-center ">
									<h1>${acItem.actType.aname}</h1>
									<input style="display:none" type="text" value="${acItem.AId}" name="itemId" />
									<div class="ibox float-e-margins">
										<div class="ibox-content">
										</div>
										<div class="form-group" style="height: 95px">
											<label class="col-sm-2" style="a">活动形式：</label>
											<textarea class="form-control " rows="2"  type="text" name="itemDesc">${acItem.aname}</textarea>
										</div>
										<div class="form-group" style="height: 95px">
											<label class="col-sm-2" style="a">基本要求：</label>
											<textarea class="form-control " rows="3"  type="text" name="require">${acItem.arequire}</textarea>
										</div>
