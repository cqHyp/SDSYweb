									...
									<div class="full-height-scroll">
										<div class="table-responsive">
											<table class="table table-striped table-hover">
												<tbody>
													<c:forEach items="${actItemlist}" var="res">
														<tr style="height:80px">
															<td class="project-title">活动类型： <small>
																	${res.actType.aname}&nbsp; </small>
															</td>
															<td class="project-title">活动形式： <small>
																	${res.aname}&nbsp; </small>
															</td>
															<td class="project-title">基本要求： <br /> <small>
																	${res.arequire}&nbsp; </small>
															</td>
											...
											<td style="text-align:center">
												<div style="text-align: center;">
													<s:if test="page1!=1">
														<a href="allActItem.action?n=0">首页</a>  

&nbsp;<a href="allActItem.action?n=1">上一页</a>
													</s:if>
													<s:if test="page1!=PageSum1">
&nbsp;<a href="allActItem.action?n=2">下一页</a>

&nbsp;<a href="allActItem.action?n=3">尾页</a>
													</s:if>
													&nbsp;第${page1}页/共${PageSum1}页
												</div>
											</td>
								...
								<script
									src="jules/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
								...
								<link href="jules/css/plugins/toastr/toastr.min.css"
									rel="stylesheet">
