...
<html>
	...
	<head>
		...
		<script src="jules/js/qrcode.min.js"></script>
								...
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										<div class="form-group" style="height: 95px">
											...
											<textarea disabled="disabled" rows="4" type="text" name="feature" class="form-control" style="width:450px">${detailactivity.RIntroduction}</textarea>
										</div>
                                  <div class="form-group" style="height: 95px">
									<label class="col-sm-2" style="a">第一次活动时间</label>
									${detailactivity.RStartTime}&nbsp;>>&nbsp;${detailactivity.REndTime}
								</div><div class="form-group" style="height: 95px">
								 <label class="col-sm-2" style="a">第二次活动时间</label>
								 ${detailactivity.RStartTimeTwo}&nbsp;>>&nbsp;${detailactivity.REndTimeTwo}
								</div>
									<div class="col-sm-10" >
								...
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										<div class="form-group" style="height: 95px;">
											...
											<span>${detailactivity.teacher.TName}</span>
										</div>
										...
										<div class="form-group" style="height: 95px">
											...
											<span>${detailactivity.teacher.TCollege}</span>
										...
										<div class="form-group" style="height: 80px;">
											...
											<textarea disabled="disabled" rows="4" type="text" name="feature" class="form-control" style="width:450px">${detailactivity.teacher.TIntroduction}</textarea>
										</div>
									</div>
								</div>
							</div>
